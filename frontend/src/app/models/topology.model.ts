...
export type NodeType = 'router' | 'switch' | 'host' | 'hub' | 'cloud' | 'server' | 'monitor' | 'tester' | 'haproxy' | 'storage';
export const NODE_TYPES: NodeType[] = ['router', 'switch', 'host', 'hub', 'cloud', 'server', 'monitor', 'tester', 'haproxy', 'storage'];
